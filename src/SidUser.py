...
# https://github.com/geekcomputers/Python/blob/master/recyclebin.py
import os  # Load the Module
# Script Name		: recyclebin.py Author				: Craig Richards Created				: 07th June 2013 Last
# Modified		: Version				: 1.0 Modifications		: Description			: Scans the recyclebin and
# displays the files in there, originally got this script from the Violent Python book
